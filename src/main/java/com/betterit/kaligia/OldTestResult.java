 ...
 *
 */
public class OldTestResult {
	
	private static final Logger log = LoggerFactory.getLogger(OldTestResult.class);
	 ...
	 * @param photon_count
	 */
	public OldTestResult(int run_id, int run_on, double[] wavenumber, double[] photon_count, JdbcTemplate jdbc) {
		this.run_id = run_id;
		this.run_on = run_on;
