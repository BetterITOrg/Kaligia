...
ALTER TABLE TestSegmentSpec DROP CONSTRAINT FKTestSegmen113649;
ALTER TABLE RunSegment DROP CONSTRAINT RunSegment;
ALTER TABLE RunSegmentLog DROP CONSTRAINT FKRunSegment178457;
...
ALTER TABLE TestSegmentSpec ADD CONSTRAINT FKTestSegmen113649 FOREIGN KEY (segment_id) REFERENCES TestSegment (segment_id);
ALTER TABLE RunSegment ADD CONSTRAINT RunSegment FOREIGN KEY (segment_id) REFERENCES TestSegment (segment_id);
ALTER TABLE RunSegmentLog ADD CONSTRAINT FKRunSegment178457 FOREIGN KEY (run_segment_id) REFERENCES RunSegment (run_segment_id);
